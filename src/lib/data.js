  ...
  contactos: [
    {
      ...
      contactos: [{ tipo: "Email", detalle: "dynamictoolscr@gmail.com" }],
    },
    {
      id: 2,
      titulo: "Ing. Mauricio Alfaro Martínez",
      especialidad: "Tool Room Manager",
      contactos: [{ tipo: "Cel", detalle: "8923 1003" }],
    },
    {
      id: 3,
      titulo: "Jose Enrique Alfaro Martínez",
      especialidad: "Tool & Die Specialist",
      contactos: [
        { id: 1, tipo: "Cel", detalle: "8989 3653" },
        { id: 2, tipo: "Email", detalle: "jalfarodynamictools@gmail.com" },
      ],
    },
  ],
};
...
export const maquinariaInfo = {
  ...
  maquinas: [
    ...
    {
      id: 5,
      titulo: "Proyector Optico de Perfiles",
      descripcion:
...
export const nosotrosInfo = {
  ...
  informacionVision: {
    ...
    descripcion:
      "Ser la opción líder para nuestros clientes en ingeniería de vanguardia.|Ofrecemos un sólido respaldo en diseño mecánico, metalmecánica, mecanizado e integración de sistemas hidráulicos, neumáticos y control eléctrico. Representamos nuestra marca con valores fundamentales de confianza, responsabilidad e integridad. ¡Nos esforzamos por superar las expectativas y ser tu socio confiable en el éxito de tus proyectos!",
  },
  informacionMision: {
  ...
  informacionValores: {
    ...
    valores: [
      ...
      },
      {
        id: 3,
        titulo: "Integridad",
        descripcion: "Operamos con honestidad, respeto y apoyo hacia los demás",
      },
      {
        id: 4,
        titulo: "Seguridad",
