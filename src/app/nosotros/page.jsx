...
export default function Nosotros () {
    return (
        <>
            ...
            <InformacionPlana id="quienesSomos" titulo={nosotrosInfo.informacionPrincipal.titulo} descripcion={nosotrosInfo.informacionPrincipal.descripcion} />
            <hr className='mb-4'></hr>
            <InformacionPlana id="valores" titulo={nosotrosInfo.informacionValores.titulo} descripcion={nosotrosInfo.informacionValores.descripcion} />
            ...
            <hr className='mb-4'></hr>
            <InformacionPlana id="vision" titulo={nosotrosInfo.informacionVision.titulo} descripcion={nosotrosInfo.informacionVision.descripcion} />
            <hr className='mb-4'></hr>
            <InformacionPlana id="mision" titulo={nosotrosInfo.informacionMision.titulo} descripcion={nosotrosInfo.informacionMision.descripcion} />
            <hr className='mb-4'></hr>
            <section className="row">
